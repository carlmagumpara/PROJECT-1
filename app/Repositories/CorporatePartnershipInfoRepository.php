...
class CorporatePartnershipInfoRepository extends BaseRepository
{
    /**
     * The Model name.
     *
     ...
     */
    private $corporatePartnershipInfo;

    public function __construct(CorporatePartnershipInfo $corporatePartnershipInfo)
    {
        $this->model = $corporatePartnershipInfo;
    }
