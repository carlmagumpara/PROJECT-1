@extends('app')
@section('title')
  E-Lawyers Online - Personal Information
@endsection
@section('content')
<div class="container">
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="card">
        <div class="card-body">
          ...
          <form action="{{ route('personal.personal-information.update') }}" method="POST" id="personal-info-form">
            {{ csrf_field() }}
            <div class="row">
              <div class="col-md-4">
            ...
            <div class="row">
              <div class="col-md-4">
                <div class="form-group">
                  <label for="work_status">Civil Status</label>
                  <select class="form-control" name="civil_status" id="civil_status">
                    <option value="">Select</option>
                    @for ($i = 0; $i < count(config('enum.civil_status')); $i++)
                    <option value="{{ config('enum.civil_status')[$i] }}" {{ $personalInfo->civil_status ==  config('enum.civil_status')[$i] ? 'selected' : '' }}>{{ config('enum.civil_status')[$i] }}</option> 
                    @endfor
                  </select>
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <div class="input-group date marriage_date">
                    <input type="text" class="form-control no-margin" name="marriage_date" id="marriage_date" value="{{ $personalInfo->marriage_date }}"  {{ $personalInfo->civil_status == 'Married' ? '' : 'disabled' }}>
                    <span class="input-group-addon">
                      <i class="fa fa-calendar" aria-hidden="true"></i>
                    </span>
                  </div>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  <label for="marriage_place" class="control-label">Marriage Place</label>
                  <input id="marriage_place" type="text" class="form-control" name="marriage_place" value="{{ $personalInfo->marriage_place }}" {{ $personalInfo->civil_status == 'Married' ? '' : 'disabled' }}>
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input id="mothers_name" type="text" class="form-control" name="mothers_name" value="{{ $personalInfo->mothers_name }}">
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  <label for="mothers_age" class="control-label">Mother's Age</label>
                  <input id="mothers_age" type="text" class="form-control" name="mothers_age" value="{{ $personalInfo->mothers_age }}">
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <label for="mothers_citizenship" class="control-label">Mother's Citizenship</label>
                  <input id="mothers_citizenship" type="text" class="form-control" name="mothers_citizenship" value="{{ $personalInfo->mothers_citizenship }}">
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  <label for="mothers_address" class="control-label">Mother's Address</label>
                  <input id="mothers_address" type="text" class="form-control" name="mothers_address" value="{{ $personalInfo->mothers_address }}">
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input id="fathers_name" type="text" class="form-control" name="fathers_name" value="{{ $personalInfo->fathers_name }}">
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  <label for="fathers_age" class="control-label">Father's Age</label>
                  <input id="fathers_age" type="text" class="form-control" name="fathers_age" value="{{ $personalInfo->fathers_age }}">
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <label for="fathers_citizenship" class="control-label">Father's Citizenship</label>
                  <input id="fathers_citizenship" type="text" class="form-control" name="fathers_citizenship" value="{{ $personalInfo->fathers_citizenship }}">
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  <label for="fathers_address" class="control-label">Father's Address</label>
                  <input id="fathers_address" type="text" class="form-control" name="fathers_address" value="{{ $personalInfo->fathers_address }}">
                </div>
              </div>
            </div>
            <div class="clearfix">
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $('[name=civil_status]').change(function(){
      if ($(this).val() == 'Married') {
        $('[name=marriage_date], [name=marriage_place]').prop('disabled', false);
      } else {
        $('[name=marriage_date], [name=marriage_place]').prop('disabled', true).val('');
      }
    });
    ...
    $('#personal-info-form').submit(function(e){
      ...
      $.post($(this).attr('action'), $(this).serializeArray() , function(data){
        ...
        if (data.result == 'success') {
          ...
          window.location = '{{ route("personal.spouse-information.index") }}';
        } else {
          $.notify({
            title: 'Error',
            message: data.message
