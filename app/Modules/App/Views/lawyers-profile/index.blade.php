@extends('app')
@section('title')
  E-Lawyers Online - Lawyer's Profile
@endsection
@section('content')
<div class="container">
  <div class="row">
    <div class="col-md-8">
      <div class="card margin-bottom-20">
        <div class="card-body">
          ...
          <p><strong>Atty. Marlon P. Valderama</strong> has an extensive law practice in immigration and investment laws, procuring various visas to foreign retirees, businessmen, expatriates and the likes as well as securing investment related ventures and incentives for them. He secured working visas for the officers of J.J. Degussa Huls, Inc., Marriott Estate Development Corp., Wi-Tribe Telecoms, Inc., among others.</p>
          <p>As the legal counsel of Colayco Foundation for Education Inc. and KSK SMP Cooperative, he handles various corporate and legal matters of these companies as well as its affiliates and subsidiaries like KMP Foods Corp., One Wealthy Nation and others.</p>
          ...
          <p><strong>REPRESENTATIVE CLIENTS: </strong>Rohde and Schwarz, Philippines, Inc., a subsidiary of Rohde and Schwarz, Inc., IVC Immigrant Visa Center, Inc., Colayco Foundation For Education, Inc., KSK SMP Cooperative, Spectracom Company, Excellent Technology Construction Corporation, FGU Builders, Inc., Blastechnik, Inc., Haru Access Loan, Inc., AMB HK Enterprises, Inc., Askim Online English Tutorial, Big Light Entertainment, Inc., Capitol Allied Trading and Transport, Inc., GnG Gaslink Corporation, Asee Enterprises, Uniform Refrigeration Systems, Inc., Porky Agriventures, Inc., BEI Auto Supply, Bright Centro Plaza Condominium Corp., Pete LPG Trading, KMP Foods Corp., Aurum Pay Corporation, and others.</p>
        </div>
      </div>
      @include('ads.big')
    </div>
