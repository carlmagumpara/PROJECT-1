    ...
    <div class="col-md-8">
      <div class="card margin-bottom-20">
        <div class="card-body">
          ...
          <div class="margin-bottom-20">
            <h2 class="margin-bottom-20"><strong>Outrageous Lawsuits</strong></h2>
            <h3>Michael Jordan sued by his look-alike for U.S.$892 Million damages</h3>
            ...
            <h3 class="margin-bottom-20">Robber Sued Homeowner Insurance for Being Trapped  By a Malfunctioning Door</h3>
